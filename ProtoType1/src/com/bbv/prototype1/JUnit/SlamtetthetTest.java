...
public class SlamtetthetTest extends AndroidTestCase {
	...
	public void testCalculation() {
		...
		assertEquals("20.0", test.calculation(1, variables1));
		assertEquals("30.0", test.calculation(2, variables1));
		assertEquals("20.0", test.calculation(3, variables1));
		assertEquals("20.0", test.calculation(4, variables1));
		assertEquals("20.0", test.calculation(5, variables1));
